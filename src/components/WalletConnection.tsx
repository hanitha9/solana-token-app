...
export const WalletConnection: React.FC = () => {
  ...
  return (
    <div className="h-screen w-screen bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 flex overflow-hidden">
      <ToastContainer 
        position="top-right"
        autoClose={5000}
      ...
      <div className="w-16 md:w-64 bg-gray-800/50 backdrop-blur-md border-r border-gray-700/50 flex-shrink-0 flex flex-col items-center md:items-start p-4">
        <h1 className="text-xl md:text-2xl font-extrabold text-white mb-8 hidden md:block">Token Studio</h1>
        ...
        <div className="mt-auto">
          <WalletMultiButton className="!bg-gradient-to-r !from-indigo-600 !to-purple-600 hover:!from-indigo-700 hover:!to-purple-700 !text-white !font-semibold !py-2 !px-4 !rounded-full !transition-all !shadow-md hover:!shadow-lg !w-full md:!w-auto" />
        </div>
      </div>
